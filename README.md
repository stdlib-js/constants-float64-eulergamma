...
```javascript
EULERGAMMA = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-eulergamma@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-eulergamma@v0.2.3-umd/browser.js"></script>
```
